...
function getWeather(){
    ...
    if(city != ''){
        ...
        $.ajax({
           url: 'http://api.openweathermap.org/data/2.5/weather?q=' + city + "&units=metric" + "&APPID=540b6759e6a7d085e3204b4de5e306ff",
            type: "GET",
            dataType: "jsonp",
            ...
            success: function(data){
                ...
                $("#city").val('');
                document.getElementById('showWeather').className = "showWeather";
            }
...
function showResults(data){
    return  '<h2 style="font-weight:bold; font-size:30px; padding-top:20px;">Current Weather for '+data.name+', '+data.sys.country+'</h2>'+
